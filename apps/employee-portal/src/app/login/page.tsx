...
export default function LoginPage() {
  ...
  const {
    ...
    defaultValues: { email: "support@limitflow.demo", password: "" },
  });
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="text-2xl font-semibold text-slate-900">LimitFlow Portal</h1>
          <p className="text-sm text-slate-500">Sign in with your support or manager account.</p>
        </div>
